...
Drawing.SimpleGraph = function(options) {
  ...
  function createGraph() {
    ...
    that.layout_options.width = that.layout_options.width || 3000;
    that.layout_options.height = that.layout_options.height || 3000;
  ...
  function drawNode(node) {
    var draw_object = new THREE.Mesh( geometry, [ new THREE.MeshBasicMaterial( {  color: 0x215280, 
  ...
  function drawEdge(source, target) {
      material = new THREE.LineBasicMaterial( { color: 0x30e5e1, opacity: 0.5, linewidth: 0.5 } );
